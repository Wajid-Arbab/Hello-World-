<div id="page-wrapper">
    <div class="content container-fluid"> 
		...
		<!--	Submit property   -->
        <div class="full-row" style = "margin-left:260px; margin-top:70px;">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center">Add Property</h2>
							<ul class="breadcrumb" style = "margin-left:-13px; margin-right:-13px">
                    ...
                    <div class="row p-5 bg-white">
                        <form method="post" enctype="multipart/form-data" action = "/admin/addPropertyByAdmin/process">
