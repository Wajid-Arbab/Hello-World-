...
<!-- property section-->	
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
											<a href = "/dashboard/propertydetail/<?= $Row->PropertyID?>">
												<div class="overlay-black overflow-hidden position-relative"><img style = "width:300px; height:300px;" src="/public/property/<?= $Row->Image?>" alt="pimage"></img>
													<div class="featured bg-success text-white"><?= $Row->IsFeatured?></div>
	  ...
	  <!--end-->
	  <?php echo str_repeat('&nbsp;', 5);?>
	<!--onchange = "myFunction(this.option[this.SelectedIndex].value)-->
