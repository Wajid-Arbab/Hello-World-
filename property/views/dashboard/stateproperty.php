							...
							?>
						      ...
						      <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="/public/property/<?= $Row->Image?>" alt="pimage">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="/dashboard/propertydetail/<?= $Row->UserID?>"><?= $Row->PTitle?></a></h5>
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
								...
								<li> <img src="/public/property/<?= $Row->Image?>" alt="pimage">
                                    <h6 class="text-secondary hover-text-success text-capitalize"><a href="/dashboard/propertydetail/<?=$Row->UserID?>"><?= $Row->PTitle?></a></h6>
                                    <span class="font-14"><i class="fas fa-map-marker-alt icon-success icon-small"></i> <?= $Row->City?></span>
